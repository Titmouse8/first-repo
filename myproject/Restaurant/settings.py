...
SECRET_KEY = 'django-insecure-hw54l%j$gd+*2#vhj(j&_z(*8srpsoe-w59w8twvj1p_rz3t-('
...
# what we want to see in authorization header - instead of Token <token> we will see JWT <token>
SIMPLE_JWT = {
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A simple Product & Order API that helps us learn Django API',
    'VERSION': '1.0.0',
